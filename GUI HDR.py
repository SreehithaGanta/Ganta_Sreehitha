...
def screen_capture():
    ...
    import time
    import os
    os.startfile("C:/Users/SREEHITHA/OneDrive/Desktop/paint")
    s1=t1.get()
    os.chdir("E:/folder/captured_images")
    os.mkdir(s1)
    os.chdir("E:/folder")
  
    images_folder="E:/folder/captured_images"+s1+"/"
    time.sleep(15)
    for i in range(0,5):
        time.sleep(12)
        im=ImageGrab.grab(bbox=(221,221,801,801)) #x1,y1,x2,y2
        print("saved......",i)
