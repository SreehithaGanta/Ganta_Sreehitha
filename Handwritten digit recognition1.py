...
images_folder="E:/folder/captured_images/9/"
  
for i in range(0,100):
    time.sleep(8)
    im=ImageGrab.grab(bbox=(221,221,801,801)) 
    print("saved......",i)
...
while True:
    ...
    cv2.waitKey(10000)
    if cv2.waitKey(1)==13: #13 is the ascii value of esc, 13 is the ascii value of enter
        break
